...
def apply_adapter_config(if_index, server_ip, client_ip,
    ...
    script = "\n".join([
        ...
        "  Set-NetAdapterAdvancedProperty -InterfaceIndex $idx -RegistryKeyword 'EnableGreenEthernet' -RegistryValue '0' -ErrorAction SilentlyContinue",
        "  Set-NetAdapterAdvancedProperty -InterfaceIndex $idx -RegistryKeyword 'PowerSavingMode' -RegistryValue '0' -ErrorAction SilentlyContinue",
        "  Set-NetAdapterAdvancedProperty -InterfaceIndex $idx -RegistryKeyword '*EEE' -RegistryValue '0' -ErrorAction SilentlyContinue",
