...
def apply_adapter_config(if_index, server_ip, client_ip,
    ...
    script = "\n".join([
        ...
        "  Set-NetAdapterAdvancedProperty -Name $name -RegistryKeyword 'EnableGreenEthernet' -RegistryValue '0' -NoRestart -ErrorAction SilentlyContinue",
        "  Set-NetAdapterAdvancedProperty -Name $name -RegistryKeyword 'PowerSavingMode' -RegistryValue '0' -NoRestart -ErrorAction SilentlyContinue",
        "  Set-NetAdapterAdvancedProperty -Name $name -RegistryKeyword '*EEE' -RegistryValue '0' -NoRestart -ErrorAction SilentlyContinue",
        ...
        '  New-NetIPAddress -InterfaceIndex $idx -IPAddress "{}" -PrefixLength {} -SkipAsSource $false -ErrorAction SilentlyContinue | Out-Null'.format(server_ip, int(prefixlen)),
